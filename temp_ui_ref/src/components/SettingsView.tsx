...
export const SettingsView: React.FC<SettingsViewProps> = ({ settings, onSaveSettings }) => {
  ...
  const [maintenanceEmail, setMaintenanceEmail] = useState(settings.maintenanceEmail);
  const [maxDailyReports, setMaxDailyReports] = useState(settings.maxDailyReports);
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="md:col-span-2 space-y-2">
              ...
              <input
                ...
                className="w-full bg-slate-50 dark:bg-slate-800 border-0 focus:ring-2 focus:ring-primary/20 rounded-xl px-4 py-3.5 text-xs font-medium text-slate-700 dark:text-slate-200 placeholder-slate-400"
              />
            </div>
