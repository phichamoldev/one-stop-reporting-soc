          ...
          <form onSubmit={handleSearch} className="space-y-5">
            <div>
              ...
              <input
                ...
                className={`w-full text-[12px] font-normal placeholder-slate-400 bg-slate-100/50 dark:bg-slate-900/50 border px-4 py-3.5 rounded-[16px] text-center tracking-wider focus:ring-2 focus:ring-primary/20 ${error ? "border-rose-500 text-rose-500" : "border-[#EDF0F4] dark:border-slate-700 text-slate-900 dark:text-white"
                  }`}
              />
