          ...
          <table className="w-full text-left border-collapse min-w-[850px]">
            <thead>
              <tr className="bg-slate-50/50 dark:bg-slate-800/30 text-[11px] font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500 border-b border-slate-100/50 dark:border-slate-800/40">
                <th className="py-4 px-6 whitespace-nowrap">เลขที่อ้างอิง</th>
                <th className="py-4 px-4 whitespace-nowrap">หมวดหมู่</th>
                <th className="py-4 px-4 whitespace-nowrap">หัวข้อ</th>
                  ...
                  >
                    ...
                    <td className="py-4 px-4 max-w-[150px]">
                      <div className="flex items-center gap-2">
                        ...
                        <span 
                          ...
                          title={report.reporter_name || "ไม่ระบุชื่อ"}
                        >
                    ...
                    <td className="py-4 px-6 text-center whitespace-nowrap">
                      <div className="flex flex-col items-center gap-1.5">
                        <span className="text-[11px] font-bold text-rose-500 whitespace-nowrap">ค้าง {report.overdueDays} วัน</span>
                        <button
                          onClick={() => router.push(`/backoffice/reports/${report.public_id}`)}
                          className="inline-flex items-center gap-1.5 px-3 py-1 bg-slate-100 hover:bg-slate-200 text-slate-600 hover:text-slate-800 dark:bg-slate-800 dark:hover:bg-slate-750 dark:text-slate-300 dark:hover:text-slate-100 rounded-xl font-bold transition-all cursor-pointer text-xs whitespace-nowrap"
                        >
